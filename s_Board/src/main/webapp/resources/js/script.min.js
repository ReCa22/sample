/*******************************************************************************
 * 
 * Custom Javascript code for AppStrap Bootstrap theme Written by Themelize.me
 * (http://themelize.me)
 * 
 ******************************************************************************/
/* global jRespond */var jPM = {}, PLUGINS_PATH = "/WebPro/resources/plugins/", SLIDER_REV_VERSION = "4.6";
jQuery(document)
      .ready(
            function() {
               "use strict";
               ...
               jQuery(".colour-switcher a").click(
                     function() {
                        ...
                        jQuery(".colour-switcher a." + e).addClass(
                              "active");
                        e !== n ? jQuery("#colour-scheme").attr(
                              "href",
                              "/WebPro/resources/css/colour-" + e
                                    + ".css?x=" + t) : jQuery(
            ...
            if (e) {
               ...
               r === undefined ? $.each(e, function(e, t) {
                  $.getScript(PLUGINS_PATH + t, s)
                     ...
                     && $.each(e, function(e, t) {
                        jQuery('script[src*="bootstrap.min.js"]')
                              .after(
                                    '<script src="' + PLUGINS_PATH
                                          + t + '"></script>');
                        s()
                     })
            }
